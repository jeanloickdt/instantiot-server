                ...
                try {
                    ...
                    for (incomingFrame in incoming) {
                        ...
                        launch(Dispatchers.IO) {
                            relayFrameToDevices(frameBytes)
                        }
                    }
                } finally {
 ...
 *   3. Trim le header DEV de la trame
 *   4. Envoyer la trame trimée au device via TCP
 */
private fun relayFrameToDevices(frameBytes: ByteArray) {
